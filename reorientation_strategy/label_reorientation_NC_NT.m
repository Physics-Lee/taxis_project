function [ratio_0_1,ratio_1_1,label_0,label_1,label,count_0,count_1,count_all] = label_reorientation_NC_NT(theta_in,theta_out)
    count_1 = 0;
    count_0 = 0;
    ...
    for i = 1:length(theta_in)
        if theta_in(i) > pi*1/2 || theta_in(i) < -pi*1/2
            count_1 = count_1 + 1;            
            if theta_out(i) > pi*1/2 || theta_out(i) < -pi*1/2
