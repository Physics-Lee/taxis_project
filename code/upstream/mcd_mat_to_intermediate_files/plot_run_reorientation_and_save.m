...
function plot_run_reorientation_and_save(run_disp,reorientation_disp,full_path_to_mcd)
...
plot_run_disp_and_reorientation_disp(run_disp_merged,reorientation_disp_merged);
