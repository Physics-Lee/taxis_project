...
function [theta,disp_vectors,path_length,disp_vectors_normalized] = from_points_to_unwrapped_theta(points)
...
% unwrap
theta = unwrap(theta,3/2*pi); % 3/2*pi as the threshold
