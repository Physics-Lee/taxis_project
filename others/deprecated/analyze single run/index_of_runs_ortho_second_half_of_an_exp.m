function index_second_half_of_an_exp = index_of_runs_ortho_second_half_of_an_exp(eset)

    index_second_half_of_an_exp = []; 
    for expt = eset.expt
                ...
                for run = track.run
                    if screen_a_run(run)
                        ...
                        if start_ind + track.startFrame > half_ind   
                            ...
                            index_second_half_of_an_exp(end+1) = L_parallel/run.pathLength;
